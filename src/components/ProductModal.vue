  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" ref="modal">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content border-0">
        <div class="modal-header header-customized">
              ...
              <div class="mt-5">
                <div class="mb-3 input-group" >
                  <input type="url" class="form-control form-control"
                          placeholder="請輸入連結">
                  <button type="button" class="btn btn-border-vintage-red">
                    移除
                  </button>
                </div>
                <div>
                  <button class="btn btn-border-vintage-tiffany btn-sm d-block w-100">
                    新增圖片
                  </button>
                </div>
              </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-vintage-l-green" @click="$emit('update-product', tempProduct)">新增</button>
        </div>
      </div>
    </div>
  </div>
